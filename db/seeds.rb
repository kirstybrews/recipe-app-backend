...
eggplant_lasagna = Recipe.create(
   name: 'Eggplant Lasagna with Artichokes and Ricotta Cheese', 
...
parmesan_crusted_cod = Recipe.create(
   name: 'Parmesan-Crusted Code with Mozzarella-Tomato Spinach Salad', 
...
lamb_with_red_pepper_jelly = Recipe.create(
   name: 'Lamb with Red Pepper Jelly and Parmesan-chive mashed pototaoes with broccolini', 
